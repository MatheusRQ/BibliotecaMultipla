...
public abstract class AudioVisual implements Identificacao {
	...
	public String toString() {
		return "ID: " + this.getId() + ", nome: " + this.getNome() + ", Ano de Lançamento: " + this.ano_de_lancamento + ", Generos: " + this.genero + ", Data de Registro: " + this.data_de_registro + ", Categoria: " + this.categoria;
	}
