...
//	}
	...
	public void TemInserirInformacoesNaTabelaDeAssistidoDoMySQL() {
		...
		Animacao_Assistido aa = new Animacao_Assistido(2, "Nome de teste", 2020, "Acao e fantasia", timestamp,
				CategoriaEnum.ANIMACAO_ORIENTAL.categoriaNome(), 12, timestamp, 6.0);
	...
	@Test
	public void TemQueInserirUmPersonagemNoMySQL() {
		
			PersonagemDAO personagemDAO = new PersonagemDAO(connection);
			Dublador dublador = new Dublador(1, "Dublador de Teste", date);
			
			Personagem personagem = new Personagem(1, "Personagem de Teste", dublador, ana);
			personagemDAO.registrar(personagem);
